  ...
  return (
    <div className="text-foreground!">
      <div className="w-[90%] md:w-[80%] mx-auto pt-8 md:pt-10">
        <Navbar />
        <div className="min-h-screen w-full  text-foreground flex justify-center py-10 md:py-20">
          <div className="w-full bg-[#0000000D] dark:bg-[#FFFFFF0D] rounded-2xl p-5 md:p-10 shadow-2xl relative overflow-hidden">
            {/* Decorative circles */}
            <div className="absolute inset-0 opacity-20 pointer-events-none">
              <div className="absolute w-[900px] h-[900px] rounded-full border border-border top-[-200px] left-[-150px]"></div>
              <div className="absolute w-[1100px] h-[1100px] rounded-full border border-border/50 top-[-300px] left-[-250px]"></div>
              <div className="absolute w-[1300px] h-[1300px] rounded-full border border-border/30 top-[-400px] left-[-350px]"></div>
            </div>
            ...
            {/* Content */}
            <div className="relative z-10 space-y-10 text-muted-foreground text-sm leading-relaxed accessibility-content">
              <section>
