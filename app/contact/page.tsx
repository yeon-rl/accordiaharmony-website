    ...
    <div className="text-foreground">
                    ...
                    <div className="flex gap-2 items-start">
                      ...
                      <div className="relative min-w-fit" ref={dropdownRef}>
                        <button
                          ...
                          className="bg-[#0B0B0B1A] dark:bg-[#F4F4F41A] rounded-lg px-3 py-2 cursor-pointer text-sm focus:outline-none focus:ring-1 focus:ring-ring border border-transparent hover:border-border transition flex items-center gap-2 min-w-[120px]"
                        >
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 my-10 md:my-20">
          <motion.div
            variants={fadeInUp}
            className="flex justify-between bg-[#4285F41A] dark:bg-[#FDFDFD1A] rounded-xl p-5"
          >
