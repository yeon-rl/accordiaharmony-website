  ...
  return (
    <footer className="relative bg-black text-gray-400 pt-24 pb-10 overflow-hidden">
      ...
      <div className="flex items-center justify-center ">
        <h1 className="text-[10vw] font-bold text-transparent bg-clip-text bg-linear-to-b from-[#4E4F50]/50 to-[#10121380]/10 tracking-tight">
          ACCORDIA HARMONY
        </h1>
      </div>

      {/* Bottom Section */}
      <div className="relative mt-5 border-t border-gray-800/50 pt-6 flex flex-col md:flex-row items-center justify-between mx-auto text-xs text-[#82888C]">
